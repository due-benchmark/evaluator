...
def read_requirements(file_path: Union[str, Path] = 'requirements.txt') -> list:
...
URL = 'https://git.applica.ai/due/due-evaluator.git'
AUTHOR = 'Applica.ai'
...
if __name__ == '__main__':
    ...
    setup(
        ...
        url=URL,
        packages=['due_evaluator'] + ['due_evaluator.' + pkg for pkg in find_packages('due_evaluator')],
        ...
        entry_points={
            "console_scripts": [
                "deval = due_evaluator.__main__:main"
            ],
        },
